...
for (var i=0; i<dataPOI.length; i++){
    if  (dataPOI[i].current_popularity == null){
        ...
        L.marker([dataPOI[i].lat,dataPOI[i].lng],{icon: leafletImage}).bindPopup("<b>"+ dataPOI[i].name  + "</b><br />Address: "+ dataPOI[i].address + "</b><br />Rating: " + dataPOI[i].rating + "</b><br />Popularity: " + "No Data for this location!").on('click', clickZoom).addTo(map);
